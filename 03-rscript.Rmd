...
- `expr` (fruther epressoins `expr2 ...`) refers to any R expression, and must be properly quoted
...
### Using Rscript with script files
...
retrieved as a charactervector with the `commandArgs()` function. 
